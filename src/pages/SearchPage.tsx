    ...
    <div className="min-h-screen pt-20 pb-16 px-4 sm:px-6" style={{ backgroundColor: '#030712' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-6 items-start">
          ...
          {/* Filtros desktop — sticky al lado izquierdo */}
              ...
              {loading ? (
                ...
                >
                  {Array.from({ length: 6 }).map((_, i) => (
                    ...
                    >
                      <div className="h-36 sm:h-48" style={{ backgroundColor: '#0f1629' }} />
                      <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
                        <div className="h-3 sm:h-4 rounded-lg w-3/4" style={{ backgroundColor: '#0f1629' }} />
                        <div className="h-2 sm:h-3 rounded-lg w-1/2" style={{ backgroundColor: '#0f1629' }} />
                      </div>
                    </div>
                  ))}
                </motion.div>
                ...
                >
                  ...
                  <p className="text-white font-bold text-lg sm:text-xl">No se encontraron juegos</p>
                  <p className="text-gray-500 text-sm">Intenta con otros filtros o términos</p>
                </motion.div>
