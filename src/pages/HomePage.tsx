...
// ── Skeleton ──────────────────────────────────────────────────────────────────
const SkeletonCard = () => (
  <div className="rounded-2xl overflow-hidden animate-pulse" style={{ backgroundColor: '#0a0f1e' }}>
...
const Section = ({ title, subtitle, linkTo, games, loading, delay = 0 }: SectionProps) => (
  <FadeIn delay={delay}>
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          <div className="flex items-center gap-3">
            <div className="w-1 h-7 sm:h-8 rounded-full" style={{ backgroundColor: '#00d4ff' }} />
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        {Array.from({ length: 3 }).map((_, i) => (
          <motion.div
            ...
            style={{ backgroundColor: '#00d4ff', left: `${20 + i * 30}%`, top: `${30 + i * 20}%` }}
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5">
                <span style={{ color: '#00d4ff' }} className="text-base sm:text-xl">★</span>
                <span className="text-white font-bold text-base sm:text-xl">{game.rating.toFixed(1)}</span>
              </div>
              {game.metacritic && (
                <span
        ...
        {games.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: '6px',
              backgroundColor: i === current ? '#00d4ff' : 'rgba(255,255,255,0.3)',
            }}
          />
        ))}
      </div>
    ...
    <div className="min-h-screen pt-16" style={{ backgroundColor: '#030712' }}>
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 w-full">
          ...
          <FadeIn delay={0.1} direction="down">
            ...
            >
              ...
              />
              <span style={{ color: '#00d4ff' }}>+500,000 juegos indexados</span>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.4}>
            <form onSubmit={handleSearch} className="flex max-w-lg mx-auto gap-2 sm:gap-3 px-4 sm:px-0">
              <input
                type="text"
                value={search}
        ...
        <FadeIn delay={0.2}>
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-1 h-7 sm:h-8 rounded-full" style={{ backgroundColor: '#00d4ff' }} />
              <div>
                <h2 className="text-2xl sm:text-3xl font-black text-white">DESTACADOS</h2>
                <p className="text-gray-500 text-xs sm:text-sm">Los mejor valorados de todos los tiempos</p>
              </div>
            </div>
            {loadingTop ? (
              <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-20 space-y-14 sm:space-y-20">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <div className="flex items-center gap-3">
                  <div className="w-1 h-7 sm:h-8 rounded-full" style={{ backgroundColor: '#00d4ff' }} />
                  <h2 className="text-2xl sm:text-3xl font-black text-white">PARA TI</h2>
                </div>
                <p className="text-gray-500 text-xs sm:text-sm pl-4">Recomendaciones que cambian cada visita</p>
              </div>
              <motion.button
              ...
              >
                <motion.span
                  ...
                  transition={{ duration: 0.5, repeat: loadingRecommended ? Infinity : 0 }}
                >
                  🔄
                </motion.span>
        ...
        <Section
          ...
          linkTo="/search?ordering=-released&dates=2025-01-01,2026-12-31"
          games={upcoming}
